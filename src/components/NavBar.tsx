      ...
      <div className="flex basis-1/12 items-center justify-center gap-10">
        {darkMode ? (
          <a
            ...
            className="hs-dark-mode-active:block group flex items-center dark:text-white dark:hover:text-orange-600 font-medium"
            href="#!"
          ...
          <a
            onClick={toggleDarkMode}
            className="group flex items-center text-black hover:text-orange-600 font-medium dark:text-gray-400 dark:hover:text-gray-500"
            href="#!"
